...
for i in np.arange(3):
    ...
    cmd = 'python train.py --net_loss_model ' + str(
        i) + ' --use_dense --gpu_ids 0 --name ft_ResNet50 --train_all --batchsize 24  --erasing_p 0.5' + ' >> ' + log_name
    print('cmd = %s' % cmd)
    os.system(cmd)

    os.system('python test.py  --use_dense --gpu_ids 0 --name ft_ResNet50  --which_epoch 59 ' + ' >>  ' + log_name)
